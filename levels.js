...
const LEVELS = [
  {
    ...
    platforms: [
      ...
      [5160, 640, 800, 260], [6080, 640, 1120, 260], [-40,  200, 40, 640], [7200, 0, 40, 840]
    ],
  ...
  },
  {
    ...
    springs: [],
    enemies: [
      { x: 4980, y: 250, minX: 4960, maxX: 5300, speed: 85, dir: 1, w: 26, h: 50, type: 'patrol' },
  ...
  },
  {
    ...
    checkpoints: [{ x: 3200, y: 500 }],
    exit: { x: 7350, y: 440, w: 40, h: 120 },
    springs: [],
    enemies: [
      // INTRODUCING FIRST NINJA STALKER: Rushes rapidly when player steps close
    ...
    hazards: [[700,  592, 500, 8], [3400, 592, 600, 8]]
  },
  {
    name: "ISOLATION",
    subtitle: "CHAPTER IV",
    ...
    checkpoints: [{ x: 4400, y: 800 }],
    exit: { x: 8500, y: 700, w: 40, h: 120 },
    springs: [
      // Floor spring placement to vault over deep structures
      [2120, 846, 80, 6, 1250]
    ],
    enemies: [
      { x: 3600, y: 600, minX: 3200, maxX: 4600, speed: 110, dir: 1, w: 26, h: 50, type: 'patrol' }
    ],
    platforms: [
    ...
    hazards: [[3500, 642, 900, 8], [7100, 892, 700, 8]]
  },
  {
    name: "CLARITY",
    subtitle: "CHAPTER V",
    ...
    checkpoints: [], exit: { x: 4850, y: 380, w: 40, h: 120 },
    springs: [], enemies: [],                             
    platforms: [
  ...
  },
  {
    ...
    springs: [
      // Dynamic bouncing chains across major hazard pits
      [1400, 796, 60, 6, 1150],
      [2200, 796, 60, 6, 1200],
      [4800, 696, 60, 6, 1300]
    ],
    enemies: [
      // Multiple tracking ninja instances guarding checkpoints
  ...
  },
  {
    ...
    mood: { veil: [240, 245, 250], grade: "rgba(255, 255, 255, 0.20)", darken: 0 },
    story: [
      "The horizon is no longer a border.",
      "Every step is light. Every shadow is quiet.",
      "Run. The sky has opened up."
    ],
    width: 6000, bottom: 900, spawn: { x: 200, y: 500 },
    checkpoints: [], exit: { x: 5600, y: 160, w: 40, h: 120 },
    springs: [
      // Mega launching array escalating player up out of bounds to the final portal walkway
      [1100, 596, 80, 4, 1450],
      [2400, 446, 80, 4, 1500],
      [3800, 346, 80, 4, 1550]
    ],
